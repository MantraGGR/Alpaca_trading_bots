...
# These become optional now, but useful if you want to log/check keys
key = os.getenv("APCA_API_KEY_ID")
secret_key = os.getenv("APCA_API_SECRET_KEY")
BASE_URL = os.getenv("APCA_BASE_URL")

api = tradeapi.REST()  # will auto-pull from environment variables
